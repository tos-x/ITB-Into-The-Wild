...
function this:internal_init()
	...
	local defaultCorpDescs = {
		Global_Texts.Corp_Grass_Description,
		Global_Texts.Corp_Desert_Description,
		Global_Texts.Corp_Snow_Description,
		Global_Texts.Corp_Factory_Description
	}
	...
	for i = 1, 4 do
		...
		m.corps[id] = _G[id]
		m.corps[id].Description = defaultCorpDescs[i]
	end
	...
	if #m.islandOrder >= 4 then
		for i = 1, 4 do
			...
			Global_Texts[self.defaultCorps[i] .."_Description"] = m.corps[island.corp].Description
